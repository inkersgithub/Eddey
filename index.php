...
//header("Location:http://m.inkers.in");
?>
        ...
        <div class="container">
          <div class="row">
            <div class="hidden-xs hidden-sm col-md-6">
              <div class="mailme">
                <a href="mailto:info@company.com"><i class="fa fa-envelope"></i>info@eddey.com</a>
              </div>
            </div>
<!--
...
<!--
                  <p><small>Browse Through the various courses with full details</small></p>
                  ...
                  <div class="hexagon-a">
                    <a class="hlinktop" href="#">
                      <div class="hexa-a">
                        <div class="hcontainer-a">
                          <div class="vertical-align-a">
                            <span class="texts-a"><i class="fa fa-university"></i></span>
                          </div>
                        </div>
                      </div>
                    </a>
                ...
                <div class="hexagon-a">
                  <a class="hlinktop" href="">
                    <div class="hexa-a">
                      <div class="hcontainer-a">
                        <div class="vertical-align-a">
                          <span class="texts-a"><i class="fa fa-money"></i></span>
                        </div>
                      </div>
                    </div>
                  </a>
...
-->
		  ...
		  <div style="margin-top: 100px;padding-bottom: 76px;text-align: center;">
		     <input style="border-radius: 14px;width: 50%;border-color: #a6daf0;height: 33px;background: white;" type="text" name="keyword" value="" placeholder="Search Here" >
			 <input style="    border-radius: 12px;width: 85px;" type="submit" class="btn btn-primary" name="search" value="Search">
		  </div>
      </div>
    </div> <!-- e/o section1 -->
          ...
          <div class="col-md-12 col-md-12">
            <div class="knobWrap">
              <div class="row">
                  ...
                  <div class="knob">
                   <h1 style="text-align:center;color: #00ace9;    text-transform: uppercase;color: #00ACE9;letter-spacing: 2px;font-size: 42px;font-weight: 600;margin-bottom: 20px;">ABOUT US</h1>
					  <p style="text-align: -webkit-center;"><small>EDDEY.in is a socially committed startup which is intended to make our         youngsters as globally recognizable citizens as well as make them proud of our rich traditions 
             	According to an international survey 25% of worlds engineers are Indians but 80% of Indian engineers are not qualified for engineering works at the same time more than 35% of NASA scientists are Indians like that 1.9% of American population are Indians but it grows up to 13% in graduate level population. These statistical reports show that Indians have the talent at its peak but our education system fails to make them a graduate where their skills and knowledge flows.
 				Actually most of our students haven’t proper knowledge about higher education because they don’t get valuable guidance from their schools, colleges or from our society.EDDEY.in have a team of experienced trainers. We strongly believe that we have to do something to solve the problems that our students are facing due to lack of awareness about higher education and its career opportunities.</small></p>  
                  </div>
                </div>
				  
                <div class="col-sm-12 col-md-12">
                  <div class="knob">
                   <h2 style="text-align:center;color: #00ace9;">VISION</h2>
					  <p style="text-align: -webkit-center;"><small>EDDEY’S ultimate aim is to standardize our education system. We are stand for guiding our upcoming citizens into a better future. We put our hands with professional trainers to help our students to select a course according to their talent and to become a life which they choose to be.</small></p>  
                  </div>
                </div>
                <div class="col-sm-12 col-md-12" style="margin-top: -11px;">
                  <div class="knob">
                    <h2 style="text-align:center;color: #00ace9;">MISSION</h2>
					 <p style="text-align: -webkit-center;"><small>To promote quality and  excellence of higher education 
						 	<br>To make our students to conscious about higher education
						 	<br>To be the choice of students for career guidance
						 	<br>To give accurate details about colleges ,universities ,courses, and various entrance exams
						 	<br>To become a better platform for students and college authorities to meet together 
						 <br>To liberalize and centralize admission procedures in private colleges</small></p>
                  </div>
                </div>
              </div>
            </div>
				...
				<div class="col-sm-12 col-md-12" style="margin-top: -40px;">
                  <div class="knob">
                   <h2 style="text-align:center;color: #00ace9;">CAREER</h2>
					  <p style="text-align: -webkit-center;"><small>If you are a trainer or a teacher and u have a motive to do something for the betterment of our education system then u can join with our team. No matter how old you are but we are looking for socially committed peoples. We are inviting you to travel with us if your motives are likely to EDDEY’S.</small></p>  
                  </div>
                </div>
...
-->
    ...
    <div style="padding-bottom:0px" id="templatemo_contact" class="section5">
      <div class="container">
        <div class="row">
          <div class="col-md-12">
            <div class="secHeader">
          ...
          <div class="col-md-3">
            <div class="addr">
              ...
              <ul>
                ...
                <li><i class="fa fa-globe"></i><a rel="nofollow" href="http://www.example.com">www.eddey.com</a></li>
                <li><i class="fa fa-envelope"></i>info@eddey.com</li>
              </ul>
            </div>
          </div>
        </div>
...
-->
      ...
      <div style="padding-bottom: 13px; background: rgba(0, 172, 233, 0.75);" class="text-center">
        <div style="margin-top: 66px; padding-top: 15px;" class="templatemo_footer">Copyright © 2017 Eddey Powered By <a href="http://inkers.in" style="color: #ffffff; font-weight: bolder;">inkers</a></div>
      </div>
